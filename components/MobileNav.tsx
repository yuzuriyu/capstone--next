        ...
        <div className="grid grid-cols-3 bg-white py-4 px-4 rounded-lg fixed bottom-4 right-0 lg:hidden z-50 shadow-2xl">
          ...
          <Link href={"/"} className="mt-2">
            <svg
              ...
              viewBox="0 0 24 24"
              className=" m-auto group-hover:fill-customblue"
              fill={`${activePage === "Profile" ? "#2FBFDE" : "#A6ABC8"}`}
            >
          ...
          <Link href={"/notification"} className="mt-2">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              onClick={() => handleActivePage("Notification")}
              className=" cursor-pointer hover:fill-customblue m-auto"
              fill={`${activePage === "Notification" ? "#2FBFDE" : "#A6ABC8"}`}
            >
          ...
          <Link href={"/achievements"} className="mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              ...
              viewBox="0 0 24 24"
              className=" cursor-pointer hover:fill-customblue m-auto"
              fill={`${activePage === "Achievements" ? "#2FBFDE" : "#A6ABC8"}`}
            >
          ...
          <div className="mt-2">
            <svg
              ...
              viewBox="0 0 24 24"
              className=" cursor-pointer hover:fill-customblue m-auto"
              fill={`${activePage === "Search" ? "#2FBFDE" : "#A6ABC8"}`}
            >
