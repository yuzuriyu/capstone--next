      ...
      <div className="lg:my-20 my-4 py-4 px-4 w-11/12 lg:w-8/12 m-auto grid md:grid-cols-3 gap-4 grid-cols-1 h-[750px] bg-white rounded-lg">
        ...
        <div className="md:col-span-2 ">
          ...
          <p className=" text-sm mb-10">
            We are the team behind the project—a group of BSIT students
            committed to developing a Footstep Power Generator using Arduino
            technology for our capstone endeavor.
          </p>
        </div>
      </div>
      <MobileNav />
